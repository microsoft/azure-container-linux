...
# Source the three implementation modules
# shellcheck source=acl/validate_common.sh
source "${_VALIDATE_MODULE_DIR}/validate_common.sh"
# shellcheck source=acl/validate_qemu.sh
source "${_VALIDATE_MODULE_DIR}/validate_qemu.sh"
# shellcheck source=acl/validate_azure.sh
