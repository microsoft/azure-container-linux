...
EOF
    ...
    # If a fasttrack preview .repo file was generated by the pipeline, copy it
    # into the installroot so dnf5 resolves fasttrack RPMs with priority=1.
...
rpm_install_package() {
    ...
    # Log fasttrack repo packages that will be preferred during install
